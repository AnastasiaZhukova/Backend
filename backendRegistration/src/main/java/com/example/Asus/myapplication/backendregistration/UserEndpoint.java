...
@Api(
        ...
        namespace = @ApiNamespace(
                ownerDomain = "backendregistration.myapplication.Asus.example.com",
                ownerName = "backendregistration.myapplication.Asus.example.com",
                packagePath = ""
        )
)
public class UserEndpoint {
    ...
    public void insert(@Named("firstName") String pFirstName, @Named("lastName") String pLastName, @Named("email") String pEmail, @Named("password") String pPassword) {
        ...
        User user = new User(pFirstName, pLastName, pEmail, pPassword);
